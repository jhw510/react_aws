...
export const tNoticeListReducer = (state = {}, action) => {
    switch (action.type) {
    ...
    return <Card>
        <CardBody>
            ...
            <div className="text-right">
                <select className="col-sm-2 t-notice-selectbox">
                    {categories}
                </select>
            </div>
            <table className="table t-notice-margin0">
                <thead>
            ...
            <div className="text-right">
                <button className="btn border-0 btn-outline-primary"><NavLink to={`${match.url}/write`}>쓰기</NavLink></button>
            </div>
